...
if (isset($_POST['submit']) && isset($_GET['id'])) {
    ...
    $dokumen_admin = mysqli_real_escape_string($koneksi, $_POST['dokumen_admin']);
                ...
                <div class="card-body">
                    ...
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" hidden class="form-control" id="dokumen_admin" name="dokumen_admin" value="<?= $data['dokumen_admin'] ?? '' ?>">
                        </div>
