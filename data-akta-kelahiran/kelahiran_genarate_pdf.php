...
$pdf->SetAuthor('Sistem Akta Kelahiran');
$pdf->SetTitle('Akta Kelahiran - ' . htmlspecialchars($data['nama_anak']));
$pdf->SetSubject('Akta Kelahiran');
...
$pdf->Cell(0, 5, 'Jenis Laporan Pencatatan Sipil', 0, 1, 'C');
$pdf->Ln(3);
...
<br>
    <tr><th>1. Nama Anak:</th><td>" . htmlspecialchars($data['nama_anak']) . "</td></tr>
    <tr><th>2. Jenis Kelamin:</th><td>" . htmlspecialchars($data['jk_anak']) . "</td></tr>
    <tr><th>3. Tempat Dilahirkan:</th><td>" . htmlspecialchars($data['tempat_lahir']) . "</td></tr>
    <tr><th>4. Tempat Kelahiran:</th><td>" . htmlspecialchars($data['tempat_lahir']) . "</td></tr>
    <tr><th>5. Hari dan Tanggal Lahir:</th><td>" . htmlspecialchars($data['tanggal_lahir_anak']) . "</td></tr>
    <tr><th>6. Pukul    :</th><td>" . htmlspecialchars($data['pukul']) . "</td></tr>
    <tr><th>7. Jenis Kelahiran  :</th><td>" . htmlspecialchars($data['jenis_kelahiran']) . "</td></tr>
    <tr><th>8. Kelahiran ke :</th><td>" . htmlspecialchars($data['kelahiran_ke']) . "</td></tr>
    <tr><th>9. Penolong Kelahiran   :</th><td>" . htmlspecialchars($data['penolong_kelahiran']) . "</td></tr>
    <tr><th>10. Berat Bayi  :</th><td>" . htmlspecialchars($data['bb_bayi']) . " kg</td></tr>
    <tr><th>11. Panjang Bayi    :</th><td>" . htmlspecialchars($data['pb']) . " cm</td></tr>
</table>";
// Tambahkan ke PDF
