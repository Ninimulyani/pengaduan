            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="profil">
                    ...
                    <div>
                        ...
                        <div style="text-align: start">
                            <span style="text-align: justify">
                                c. Pembinaan dan pelaksanaan tugas pemerintahan di tingkat kecamatan; <br> </span>
                            <span style="text-align: justify">
                                d. Pelaksanaan tugas kesekretariatan kantor kecamatan; dan <br> </span>
                        </div>
                        <div style="text-align: start">
                            <span style="text-align: justify">
                    ...
                    <div style="text-align: justify">
                        ...
                        4. Penyediaan data kependudukan yang akurat; <br />
                        5. Pemeliharaan dan pengembangan sarana prasarana kecamatan.
                    </div>
                </div>
                <!-- End Profil Dinas -->
